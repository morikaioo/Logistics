...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
            <dt>教室维护</dt>
			<dd class=""><a href="${ctx}/page/teacher/guarantee.jsp"><i class="icon sideicon1"></i>教室报修</a><i class="icon sideicon2"></i></dd>
        	...
        	<dd class="active"><a href="${ctx}/page/teacher/detailInfo.jsp"><i class="icon sideicon1"></i>详细信息</a><i class="icon sideicon2"></i></dd>
        </dl>
