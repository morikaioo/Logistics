    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
			...
			<dd class="teacherOpreate"><a href="${ctx}/page/teacher/guarantee.jsp"><i class="icon sideicon1"></i>教室报修</a><i class="icon sideicon2"></i></dd>
		 	<dd class="active"><a href="${ctx}/page/teacher/repair.jsp"><i class="icon sideicon1"></i>教室维修</a><i class="icon sideicon2"></i></dd>
...
<script type="text/javascript">
	...
	function selectLimit(){
		$.ajax({
			type: "get",
			url: "${ctx}/repairs/selectLimit?repairsCategory=教室维修&judge=j",
			dataType: 'html',
