...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
            <dt>学生宿舍</dt>
			<dd class="active"><a href="${ctx}/page/student/guarantee.jsp"><i class="icon sideicon1"></i>宿舍报修</a><i class="icon sideicon2"></i></dd>
    ...
    <div class="rigCont fr">
        <div class="detailsRig pb30" style="height:400px;">
            ...
            <div id="info" class="detailsCont" style="margin-top: 20px; text-align:left;">
  			...
  			<input type="reset" id="reset" class="btn btn-info" value="重置" style="width:200px;height:34px;position:relative;top:-69px;left:213px;">
  			</form>       
          </div>
        </div>
    </div>
