...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
        	...
        	<dd class="active"><a href="${ctx}/page/student/sanitation.jsp"><i class="icon sideicon1"></i>宿舍保洁</a><i class="icon sideicon2"></i></dd>
        </dl>
        
    </div>
    <div class="rigCont fr">
        <div class="detailsRig pb30" style="height:400px;">
            <h4 class="detailsTitle">宿舍保洁</h4>
...
<script type="text/javascript">
	...
	function selectLimit(){
		$.ajax({
			type: "get",
			url: "${ctx}/repairs/selectLimit?repairsCategory=宿舍保洁"+"&judge=s",
			dataType: 'html',
