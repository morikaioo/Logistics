...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
            <dt>食堂采购</dt>
            <dd class="userOpreate"><a href="${ctx}/page/employer/buyer/addBuyer.jsp"><i class="icon sideicon1"></i>添加信息</a><i class="icon sideicon2"></i></dd>
			<dd class="active"><a href=""><i class="icon sideicon1"></i>采购信息</a><i class="icon sideicon2"></i></dd>		 
        </dl>
        
    </div>
    <div class="rigCont fr">
        <div class="detailsRig pb30" style="height:400px;">
            <h4 class="detailsTitle">采购信息</h4>
