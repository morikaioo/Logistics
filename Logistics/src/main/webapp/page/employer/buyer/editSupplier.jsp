...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
            <dt>编辑信息</dt>
			<dd class=""><a href="${ctx}/page/employer/buyer/addSupplier.jsp"><i class="icon sideicon1"></i>添加供应商信息</a><i class="icon sideicon2"></i></dd>
        ...
        <div class="detailsRig pb30" style="height:400px;">
            ...
            <div class="detailsCont" style="margin-top: 20px; text-align:center;height:400px;">
         	 ...
         	 <form class="form-horizontal" role="form" id="supplierForm">   	 
    			...
    			<div class="col-sm-10">
      				<input type="text" value="${supplier.supplierName}" class="form-control" id="supplierName" name="supplierName">
    			</div>
  			</div>         	 
         	 <div class="form-group">
    			<label class="col-sm-2 control-label" for="inputError">联系电话:</label>
    			<div class="col-sm-10">
      				<input type="text" value="${supplier.Contact}" class="form-control" id="Contact" name="Contact">
    			</div>
  			</div>
  			<div class="form-group">
  			...
  			<input type="button" onclick="supplier()" class="btn btn-success" value="提交" style="width:200px;height:34px;position:relative;top:-79px;left:123px;">
...
<script type="text/javascript">
	...
	function supplier(){
		var data = $('#supplierForm').serializeArray();
		...
		$.ajax({
			type: "post",
			url: "${ctx}/supplier/insertSupplier?category=edit&&supplierId=${supplier.supplierId}",
