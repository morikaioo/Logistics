...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
            <dt>添加信息</dt>
            <dd class="active"><a href="${ctx}/page/employer/buyer/supplier.jsp"><i class="icon sideicon1"></i>供应商信息</a><i class="icon sideicon2"></i></dd> 
			<dd class="active"><a href="${ctx}/page/employer/buyer/addBuyer.jsp"><i class="icon sideicon1"></i>添加信息</a><i class="icon sideicon2"></i></dd>
        ...
        <div class="detailsRig pb30" style="height:400px;">
            ...
            <div class="detailsCont" style="margin-top: 20px; text-align:center;height:400px;">
  			...
  			<div class="form-group" style="position: relative;top:-89px;left:300px;">
    			...
    			<div class="col-sm-10">
      				<input type="text" class="form-control" id="foodNumber" name="foodNumber" placeholder="kg">
    			</div>
  			</div>
