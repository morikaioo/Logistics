    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
			...
			<dd class=""><a href="${ctx}/page/employer/campus/greening.jsp"><i class="icon sideicon1"></i>校园绿化</a><i class="icon sideicon2"></i></dd>
		 	<dd class="active"><a href="${ctx}/page/employer/campus/facility.jsp"><i class="icon sideicon1"></i>设施维护</a><i class="icon sideicon2"></i></dd>
...
<script type="text/javascript">
	...
	function selectLimit(){
		$.ajax({
			type: "get",
			url: "${ctx}/repairs/selectLimit?repairsCategory=设施维护",
			dataType: 'html',
