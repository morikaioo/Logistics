...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
			...
			<dd class="active"><a href="${ctx}/page/employer/campus/greening.jsp"><i class="icon sideicon1"></i>校园绿化</a><i class="icon sideicon2"></i></dd>
...
<script type="text/javascript">
	...
	function selectLimit(){
		$.ajax({
			type: "get",
			url: "${ctx}/repairs/selectLimit?repairsCategory=校园绿化",
			dataType: 'html',
