...
<div class="w1100 clearfix" style="height:600px">
    <div class="place" style="padding: 46px 0;"><i class="icon homeicon"></i><em><a href="">主页</a> &gt; <a href="">物资管理</a> &gt;编辑信息</em></div>
    <div class="leftmenu fl">
		<dl class="sidemenu">
            <dt>编辑信息</dt>
			<dd class=""><a href="${ctx}/page/employer/material/addMaterial.jsp"><i class="icon sideicon1"></i>添加信息</a><i class="icon sideicon2"></i></dd>
    ...
    <div class="rigCont fr">
        <div class="detailsRig pb30" style="height:400px;">
            ...
            <div class="detailsCont" style="margin-top: 20px; text-align:center;height:400px;">
         	 <c:set value="${material}" var="material"/>
         	 <form class="form-horizontal" role="form" id="materialForm">
         	 <div class="form-group">
    			<label class="col-sm-2 control-label" for="inputError">物品编号:</label>
    			<div class="col-sm-10">
      				<input type="text" value="${material.materialNum}" class="form-control" id="materialNum" name="materialNum">
    			</div>
  			</div>
         	 <div class="form-group">
    			<label class="col-sm-2 control-label" for="inputError">物品名称:</label>
    			<div class="col-sm-10">
      				<input type="text" value="${material.detailedStuff}" class="form-control" id="detailedStuff" name="detailedStuff">
    			</div>
  			</div>
  			...
  			<script>
  				$("#materialCategory option").each(function(){
				   if($(this).text() == '${material.materialCategory}'){
  			...
  			<div class="form-group" style="position: relative;top:-39px;">
    			...
    			<div class="col-sm-10">
      				<input type="text" value="${material.materialNumber}" class="form-control" id="materialNumber" name="materialNumber">
    			</div>
  			</div>
  			...
  			<script>
  				$("#materialStatus option").each(function(){
				   if($(this).text() == '${material.materialStatus}'){
				      $(this).attr('selected', 'selected');
				   }
				});
            </script>
  			<div class="form-group" style="position: relative;top:-79px;">
    			...
    			<div class="col-sm-10">
      				<input type="text" value="${material.principal}" class="form-control" id="principal" name="principal" readonly="readonly">
    			</div>
  			</div>
...
<script type="text/javascript">
	...
	function material(){
		...
		$.ajax({
			type: "post",
			url: "${ctx}/material/insertMaterial?category=edit&&materialId=${material.materialId}",
