...
<div class="w1100 clearfix" style="height:600px">
    ...
    <div class="leftmenu fl">
		<dl class="sidemenu">
			...
			<dd class="active"><a href="${ctx}/page/employer/material/stuff.jsp"><i class="icon sideicon1"></i>材料清单</a><i class="icon sideicon2"></i></dd>
		 	<dd class=""><a href="${ctx}/page/employer/material/tool.jsp"><i class="icon sideicon1"></i>工具清单</a><i class="icon sideicon2"></i></dd>
        </dl>
        
    </div>
    <div class="rigCont fr">
        <div class="detailsRig pb30" style="height:400px;">
            <h4 class="detailsTitle">材料清单</h4>
...
<script type="text/javascript">
	...
	function selectLimit(){
		$.ajax({
			type: "get",
			url: "${ctx}/material/selectLimit?materialCategory=材料",
			dataType: 'html',
